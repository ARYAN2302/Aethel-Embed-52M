...
def run_benchmark():
    ...
    print(f"\n>>> Aethel-52M vs. BGE-M3 (560M) Benchmark <<<")
    print(f"Sequence length: {DOC_LEN_TOKENS} tokens. Device: NVIDIA A10G.")
    ...
    # Using the tokenizer compatible with training
    ...
    if aethel_score > 0.5:
        ...
        if abs(aethel_score - bge_score) < 0.15:
            print("Summary: Aethel matches accuracy at significantly lower latency.")
    else:
        print("Recall:  Aethel missed the needle.")